...
public static class CWOracleHooks
{
    ...
    static void On_OracleGraphics_DrawSprites(On.OracleGraphics.orig_DrawSprites orig, OracleGraphics self, RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
    {
        ...
        {
            var ch1 = or.bodyChunks[1];
            var fc = or.firstChunk;
            Vector2 vector13f = Vector2.Lerp(ch1.lastPos, ch1.pos, timeStacker),
                vector = Vector2.Lerp(fc.lastPos, fc.pos, timeStacker),
            ...
            if (behav.killFac > 0f)
            {
                ...
                if (behav.player is Player p)
                {
                    ...
                    ks.x = Mathf.Lerp(mbc.lastPos.x, mbc.pos.x, timeStacker) - camPos.x;
                    ks.y = Mathf.Lerp(mbc.lastPos.y, mbc.pos.y, timeStacker) - camPos.y;
                }
            ...
            for (var k = 0; k < 2; k++)
            {
                ...
                var num2 = k == 1 ? -1f : 1f;
                var hand1 = self.hands[k];
                Vector2 vector12 = Vector2.Lerp(hand1.lastPos, hand1.pos, timeStacker),
                ...
                var ft = self.feet[k];
                vector12 = Vector2.Lerp(ft.lastPos, ft.pos, timeStacker);
